...
swagger-wiki/1.0.0 darwin-x64 node-v10.16.0
...
_See code: [src/commands/update.ts](https://gitlab.com/AdaptiveRx/DevOps/swagger-wiki/blob/v1.0.0/src/commands/update.ts)_
<!-- commandsstop -->
