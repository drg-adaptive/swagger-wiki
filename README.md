...
swagger-wiki/1.0.3 darwin-x64 node-v10.16.0
...
_See code: [src/commands/update.ts](https://github.com/drg-adaptive/swagger-wiki/blob/v1.0.3/src/commands/update.ts)_
<!-- commandsstop -->
